...
graph_params_dict = {
    'chain': GraphParams(p=100, N=[500,1000], eta=1, ratios=None, d=None), #p, N, eta
    'star': GraphParams(p=100, d=[10, 20, 30, 50], N=50, eta=1, ratios=None), #p, d, N, eta
    'random': GraphParams(p=100, d=0.01, ratios=[r/100. for r in [500,1000]], eta=1, N=None), #p, d, ratio over 500, eta
...
with open("{}_LARGE_N_algo_params.pkl".format(run_name), 'wb') as f:
	pickle.dump(algo_params, f)

with open("{}_LARGE_N_graph_params_dict.pkl".format(run_name), 'wb') as f:
